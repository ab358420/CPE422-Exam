...
enum GPIO_DIRECTION{ INPUT, OUTPUT }; // enum starts numbering stuff starting from 0
enum GPIO_VALUE{ LOW=0, HIGH=1 };
enum GPIO_EDGE{ NONE, RISING, FALLING, BOTH }; // enum=enumering, NONE=0, RISING=1, FALLING=2, BOTH=3
